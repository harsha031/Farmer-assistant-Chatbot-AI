...
__all__ = [
    ...
    'DISPID_SGRsDynamic', 'SECFDefault', 'DISPID_SDKSetBinaryValue',
    'DISPID_SPRDisplayAttributes', 'SAFT11kHz16BitMono',
    'SP_VISEME_9', 'DISPID_SGRClear', 'SREInterference',
    'DISPID_SRGRules', 'DISPID_SGRSAddWordTransition', 'SVP_20',
    'SSSPTRelativeToEnd', 'SPBOOKMARKOPTIONS', 'DISPID_SVDisplayUI',
    'SPEI_MIN_SR', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPSHT_OTHER', 'DISPID_SLGetWords', 'SPTEXTSELECTIONINFO',
    'SVP_17', 'SpPhoneConverter', 'SECNormalConfidence',
    'DISPID_SLAddPronunciationByPhoneIds', 'SGLexicalNoSpecialChars',
    'DISPID_SRCEventInterests', 'DISPID_SRCRetainedAudioFormat',
    'SpeechRuleAttributes', 'SAFTTrueSpeech_8kHz1BitMono',
    'SECFNoSpecialChars', 'SpeechRecognitionType', 'SPSHT_Unknown',
    'SPVISEMES', 'ISpeechXMLRecoResult', 'eLEXTYPE_APP',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpeechLexiconPronunciation',
    'DISPID_SpeechRecognizerStatus', 'SGDSActiveWithAutoPause',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPIGrammarId',
    'DISPID_SVSLastBookmark', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRTTickCount', 'DISPID_SVSLastResult', 'SPSSuppressWord',
    'SpeechRecoContextState', 'DISPID_SRProfile', 'ISpRecognizer',
    'DISPID_SVVoice', 'SRATopLevel', 'DISPID_SPRuleConfidence',
    'DISPID_SRCResume', 'DISPID_SRCEPhraseStart', 'SPEI_RESERVED1',
    'DISPIDSPTSI_ActiveOffset', 'SpTextSelectionInformation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SVEventInterests', 'DISPID_SMSADeviceId',
    'SpeechVisemeFeature', 'DISPID_SRCEStartStream',
    'SAFT44kHz16BitMono', 'DISPID_SASFreeBufferSpace',
    'STCRemoteServer', 'SREAllEvents', 'DISPID_SRRAlternates',
    'DISPID_SOTsCount', 'ISpeechWaveFormatEx',
    ...
    'DISPID_SRCEBookmark', 'UINT_PTR', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFT8kHz16BitMono', 'SPRS_INACTIVE', 'SAFT16kHz8BitMono',
    'SPEI_HYPOTHESIS', 'SPEI_PHRASE_START',
    'DISPID_SPPBRestorePhraseFromMemory',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechPhraseRules',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SDKGetlongValue',
    'ISpeechRecoGrammar', 'SPADAPTATIONRELEVANCE',
    'SpeechGrammarState', 'SpeechAudioProperties', 'SVP_3',
    'DISPID_SLPSymbolic', 'SpeechBookmarkOptions', 'SREStateChange',
    'SVF_Stressed', 'SpCustomStream', 'SREAdaptation',
    'DISPID_SRGReset', 'SpPhraseInfoBuilder', 'DISPID_SABIBufferSize',
    'DISPID_SRGCmdSetRuleIdState',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechPhraseAlternate', 'SRAImport', 'ISpMMSysAudio',
    'DISPID_SOTCGetDataKey', 'DISPID_SMSGetData',
    'DISPID_SpeechPhraseInfo', 'ISpeechPhraseElement', 'tagSTATSTG',
    'DISPID_SPCLangId', 'DISPID_SLWs_NewEnum',
    'DISPID_SVSInputWordPosition', 'ISpAudio',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpeechDisplayAttributes', 'SPEI_REQUEST_UI', 'SpStream',
    'SpeechFormatType', 'SPEI_VISEME', 'SpMMAudioEnum',
    'DISPID_SVEViseme', 'ISpRecoGrammar', 'SRTExtendableParse',
    'DISPID_SPELexicalForm', 'SVEVoiceChange', 'SPFM_OPEN_READWRITE',
    'eLEXTYPE_PRIVATE10', 'eLEXTYPE_PRIVATE19', 'DISPID_SDKOpenKey',
    'SP_VISEME_13', 'SAFTADPCM_22kHzMono', 'ISpeechPhraseAlternates',
    'SAFT11kHz8BitMono', 'DISPID_SRCVoice', 'SpeechRuleState',
    'SPFM_CREATE', 'SAFTCCITT_uLaw_8kHzMono', 'SAFT12kHz16BitStereo',
    'SpeechEngineProperties', 'ISequentialStream',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRRAudio', 'SpNullPhoneConverter',
    'ISpShortcut', 'DISPID_SGRSAddRuleTransition', 'DISPID_SLWType',
    ...
    'SpSharedRecoContext', '_RemotableHandle', 'SVP_6',
    'DISPID_SRRTStreamTime', 'DISPID_SPPValue',
    'DISPID_SRCEAdaptation', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SOTId', 'SVEAllEvents', 'DISPID_SVStatus',
    'SPDKL_DefaultLocation', 'ISpVoice',
    'DISPID_SPIEnginePrivateData', 'SPFM_OPEN_READONLY',
    'DISPID_SRCRequestedUIType', 'DISPID_SPIProperties',
    'ISpEventSink', 'DISPID_SGRSTWeight', 'SpeechWordPronounceable',
    'SVEWordBoundary', 'DISPID_SRGSetWordSequenceData',
    'SPCS_DISABLED', 'DISPID_SRSCurrentStreamNumber',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPPS_Interjection',
    'SAFT24kHz8BitMono', 'SPAUDIOOPTIONS', 'SVP_7', 'SP_VISEME_15',
    'DISPID_SCSBaseStream', 'DISPID_SVGetAudioOutputs',
    'IInternetSecurityMgrSite', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SDKCreateKey', 'ISpeechBaseStream', 'SpResourceManager',
    'eLEXTYPE_PRIVATE6', 'DISPID_SPIReplacements',
    'SpeechTokenKeyAttributes', 'DISPID_SPPEngineConfidence',
    'DISPID_SGRSRule', 'ISpPhoneticAlphabetSelection', 'SpLexicon',
    'SVESentenceBoundary', 'DISPID_SPRuleId', 'SPRST_ACTIVE_ALWAYS',
    'SPPHRASEELEMENT', 'SRERequestUI',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SLAddPronunciation',
    'DISPID_SPIAudioStreamPosition', 'SpMMAudioIn', 'DISPID_SPAsItem',
    'ISpPhoneticAlphabetConverter', 'SAFT32kHz8BitMono',
    'SP_VISEME_1', 'DISPID_SPIAudioSizeTime', 'DISPID_SAFType',
    'SpFileStream', 'SPRST_INACTIVE', 'DISPID_SPRText',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechRecoContextEvents',
    'SPLOADOPTIONS', 'DISPID_SPAsCount', 'SPCT_SUB_COMMAND',
    'DISPIDSPTSI_SelectionOffset', 'SDTDisplayText', 'SP_VISEME_10',
    'ISpeechGrammarRuleState', 'SREPropertyNumChange', 'SPRS_ACTIVE',
    'DISPID_SPRNumberOfElements', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechVoiceEvent', 'SDTPronunciation', 'SSFMOpenForRead',
    'SVP_4', 'eLEXTYPE_PRIVATE2', 'SDTAll', 'SRADynamic', 'SDTRule',
    'ISpPhrase', 'SPSTREAMFORMATTYPE', 'DISPID_SOTRemove',
    'SAFT12kHz8BitMono', 'DISPID_SRCCreateGrammar',
    'DISPID_SGRSTPropertyValue', 'DISPIDSPRG',
    '_ISpeechRecoContextEvents', 'DISPID_SPERetainedSizeBytes',
    'SDKLLocalMachine', 'SVP_11',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpNotifyTranslator', 'SVP_10', 'SPSFunction',
    'SPRECOCONTEXTSTATUS', 'SPEI_VOICE_CHANGE', 'SPVOICESTATUS',
    'SPEI_SR_BOOKMARK', 'SPWORDPRONOUNCEABLE', 'SPSVerb',
    'SpeechDataKeyLocation', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpSerializeState', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCESoundEnd', 'SPSHORTCUTPAIRLIST', 'DISPID_SGRSTsItem',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPPId', 'SVSFIsFilename', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPAR_High', 'DISPID_SpeechPhraseElements', 'SpSharedRecognizer',
    'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE3', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPEPronunciation', 'SPCT_DICTATION', 'DISPID_SVEWord',
    'DISPID_SRCERequestUI', 'SpCompressedLexicon',
    'SPXRO_Alternates_SML', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SLWsCount', 'DISPID_SLPsItem', 'SPPS_Noun',
    'SPPS_RESERVED2', 'SVP_19', 'SAFTCCITT_uLaw_22kHzMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT48kHz16BitStereo',
    'SPEI_RESERVED5', 'SpeechInterference', 'SAFT8kHz16BitStereo',
    'SDA_No_Trailing_Space', 'ISpPhraseAlt', 'DISPID_SPEDisplayText',
    'LONG_PTR', 'SPSInterjection', 'SpeechTokenValueCLSID',
    'SPWT_DISPLAY', 'DISPID_SRGDictationUnload', 'SVP_21',
    'SpeechPropertyLowConfidenceThreshold',
    'SpeechPropertyResourceUsage', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPPsCount', 'SpeechCategoryPhoneConverters',
    'ISpRecoResult', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SVEVoiceChange', 'SPEI_MIN_TTS', 'SP_VISEME_2',
    'DISPID_SVSPhonemeId', 'SREStreamEnd', 'SGSDisabled',
    'DISPID_SRGCommit', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPRuleNumberOfElements', 'SpInprocRecognizer',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPAs_NewEnum', 'SpVoice',
    'SP_VISEME_20', 'SAFTNonStandardFormat', 'SPEI_RESERVED2',
    'SAFTCCITT_ALaw_22kHzMono', 'SPEVENT', 'SAFTText',
    'SpeechCategoryVoices', 'SAFTADPCM_8kHzMono',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechLexicon', 'SDTProperty',
    'DISPID_SVPriority', 'DISPID_SASCurrentSeekPosition',
    'SPWORDPRONUNCIATION', 'SAFTExtendedAudioFormat',
    'SpeechTokenIdUserLexicon', 'SPSLMA', 'SPEVENTSOURCEINFO',
    'SP_VISEME_16', 'STCLocalServer', 'SAFTGSM610_44kHzMono',
    'SVSFDefault', 'SVSFlagsAsync', 'SPFM_NUM_MODES',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SWFEBitsPerSample',
    'ISpRecognizer3', 'DISPID_SRGCmdLoadFromObject',
    'eLEXTYPE_USER_SHORTCUT', 'SPWF_INPUT', 'SREFalseRecognition',
    'SPCONTEXTSTATE', 'DISPID_SVEBookmark', 'SGDSActive', 'SPPS_Verb',
    'SPBINARYGRAMMAR', 'DISPID_SOTDisplayUI', 'SpeechAddRemoveWord',
    'SPPS_Noncontent', 'DISPID_SLPLangId',
    'DISPID_SPEEngineConfidence', 'DISPID_SRSClsidEngine',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechVoiceStatus',
    'SpeechCategoryAudioOut', 'DISPID_SASNonBlockingIO',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_uLaw_44kHzMono',
    'SREPrivate', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechRecoResult', 'DISPID_SPANumberOfElementsInResult',
    'SDA_Two_Trailing_Spaces', 'DISPID_SABufferInfo',
    'SpeechVoiceSpeakFlags', 'DISPID_SLGetPronunciations',
    'eLEXTYPE_PRIVATE8', 'SRSEIsSpeaking', 'IInternetSecurityManager',
    'STSF_AppData', 'DISPID_SPARecoResult', 'SPEI_END_SR_STREAM',
    'DISPID_SRCBookmark', 'DISPID_SPEsCount',
    'SpeechStreamSeekPositionType', 'DISPID_SRGSetTextSelection',
    'DISPID_SLGetGenerationChange', 'SpMemoryStream',
    'SPSHT_NotOverriden', 'Speech_Max_Pron_Length',
    'SpeechEmulationCompareFlags', 'DISPID_SPRFirstElement',
    'SP_VISEME_3', 'ISpObjectToken', 'SPPS_Function',
    'SpeechEngineConfidence', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCEAudioLevel', 'DISPID_SPPConfidence', 'SpeechWordType',
    'DISPID_SABIEventBias', 'eLEXTYPE_RESERVED7',
    'DISPID_SLWPronunciations', 'DISPID_SAStatus',
    'DISPID_SPRuleChildren', 'DISPID_SPEs_NewEnum',
    'SpeechGrammarTagWildcard', 'SRAONone', 'SpeechTokenKeyUI',
    'ISpProperties', 'DISPID_SpeechPhraseProperty', 'SASStop',
    'SAFT48kHz8BitMono', 'eLEXTYPE_RESERVED9',
    'DISPID_SRCCreateResultFromMemory', 'ISpPhoneConverter',
    'DISPID_SGRAddState', 'DISPID_SPISaveToMemory', 'SPPROPERTYINFO',
    'WAVEFORMATEX', 'SAFTADPCM_8kHzStereo',
    'SpeechRetainedAudioOptions', 'STCInprocHandler',
    'SWPUnknownWordPronounceable', 'DISPID_SPPParent',
    'SGRSTTTextBuffer', 'SVP_8', 'DISPID_SGRsItem',
    'SAFTNoAssignedFormat', 'SpeechRunState', 'SLODynamic',
    'Speech_StreamPos_Asap', 'SPPS_RESERVED4', 'DISPID_SGRs_NewEnum',
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_14',
    'DISPID_SVWaitUntilDone', 'SGSExclusive',
    'DISPID_SOTGetAttribute', 'SpWaveFormatEx', 'SPAS_PAUSE',
    'DISPID_SPRulesItem', 'SVEStartInputStream',
    'DISPID_SDKGetBinaryValue', 'DISPID_SGRInitialState',
    'DISPID_SLRemovePronunciationByPhoneIds', 'tagSPPROPERTYINFO',
    'SpeechAudioFormatType', 'DISPID_SAVolume',
    'SpUnCompressedLexicon', 'SPAUDIOSTATUS', 'SVP_13',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT16kHz8BitStereo',
    'DISPID_SOTs_NewEnum', 'DISPID_SGRSTRule', 'SVSFNLPSpeakPunc',
    'SVSFNLPMask', 'ISpeechMMSysAudio', 'SP_VISEME_18',
    'ISpeechObjectToken', 'ISpeechRecognizerStatus', 'SITooFast',
    'DISPID_SRRTimes', 'DISPID_SBSWrite', 'ISpeechRecoResultTimes',
    'SPEI_PHONEME', 'SVEBookmark', 'SPAR_Unknown',
    'SPINTERFERENCE_NONE', 'DISPID_SRDisplayUI', 'SPEVENTENUM',
    'SASClosed', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVSInputWordLength', 'DISPID_SLWsItem',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SDKSetLongValue',
    'SPGRAMMARSTATE', 'DISPID_SBSFormat',
    'DISPID_SRCSetAdaptationData', 'SREPropertyStringChange',
    'DISPID_SVSpeakStream', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SpeechWaveFormatEx', 'SVPAlert', 'DISPID_SDKEnumKeys',
    'SITooSlow', 'SGRSTTWord', 'DISPID_SVAudioOutput', 'SPWORDTYPE',
    'ISpeechFileStream', 'SPEI_MAX_TTS', 'SpeechAudioFormatGUIDText',
    'SINone', 'SPVPRI_NORMAL', 'SPEI_TTS_BOOKMARK', 'SREPhraseStart',
    'SpeechSpecialTransitionType', 'ISpObjectWithToken',
    'SREHypothesis', 'SGSEnabled', 'SPDATAKEYLOCATION',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRIsUISupported', 'SAFT48kHz16BitMono', 'SGRSTTRule',
    'SWTDeleted', 'ISpXMLRecoResult',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechVoiceStatus',
    'ISpLexicon', 'SGPronounciation', 'DISPID_SVSpeak',
    'ISpeechResourceLoader', 'SVEPrivate', 'ISpeechPhraseAlternate',
    'DISPID_SLWLangId', 'DISPID_SRCERecognitionForOtherContext',
    'SAFTCCITT_ALaw_44kHzMono', 'eWORDTYPE_ADDED',
    'SPEI_INTERFERENCE', 'SAFT8kHz8BitStereo',
    'DISPID_SDKGetStringValue', 'SPSEMANTICFORMAT',
    'SpeechRecoEvents', 'ISpeechPhraseInfo', 'SVSFPersistXML',
    'SREAudioLevel', 'SAFT24kHz16BitMono', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechAudio', 'Speech_StreamPos_RealTime',
    'SPDKL_CurrentUser', 'SPAS_STOP', 'ISpRecoContext',
    'SAFTADPCM_22kHzStereo', 'SGRSTTDictation', 'ISpeechCustomStream',
    'SVP_9', 'DISPID_SPIElements', 'SWTAdded', 'SPRECOSTATE',
    'DISPID_SPACommit', 'SPPS_RESERVED3', 'DISPID_SRGId',
    'SRSInactive', 'DISPID_SVEStreamStart', 'SPWT_LEXICAL',
    'eLEXTYPE_MORPHOLOGY', 'SVSFUnusedFlags', 'DISPID_SVEAudioLevel',
    'SRESoundEnd', 'DISPID_SpeechCustomStream', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechMemoryStream', 'SPXMLRESULTOPTIONS',
    'DISPID_SLWWord', 'SpeechStreamFileMode', 'DISPID_SPIEngineId',
    'DISPID_SPPFirstElement', 'SPINTERFERENCE',
    'DISPID_SPEAudioTimeOffset', 'SpeechVoicePriority',
    'ISpeechPhraseProperties', 'eLEXTYPE_PRIVATE1', 'SBONone',
    'SpeechDiscardType', 'DISPID_SVSLastBookmarkId',
    'eWORDTYPE_DELETED', 'SPGS_DISABLED', 'SDTLexicalForm',
    'ISpRecoContext2', 'eLEXTYPE_PRIVATE11', 'SPPHRASEREPLACEMENT',
    'SVP_5', 'SVSFParseMask', 'DISPID_SGRsFindRule',
    'SVSFParseAutodetect', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SGRSTs_NewEnum', 'ISpeechAudioBufferInfo',
    'DISPID_SVGetProfiles', 'SFTInput', 'DISPID_SGRName',
    'DISPID_SRCESoundStart', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVESentenceBoundary', 'SAFT44kHz8BitStereo',
    'DISPID_SOTCEnumerateTokens', 'ISpeechPhraseProperty',
    'DISPID_SpeechGrammarRule', 'ISpeechRecoResult', 'SINoSignal',
    'DISPID_SGRAddResource', 'DISPID_SRSCurrentStreamPosition',
    'SRAORetainAudio', 'DISPID_SPEAudioSizeTime',
    'SAFTGSM610_11kHzMono', 'DISPID_SGRSTPropertyName',
    'ISpeechRecoResult2', 'DISPID_SOTCSetId', 'DISPID_SOTSetId',
    'SpAudioFormat', 'SECFIgnoreWidth', 'ISpeechAudioFormat',
    'DISPID_SRCEEnginePrivate', 'SWPKnownWordPronounceable',
    'ISpObjectTokenCategory', 'SPSHT_EMAIL', 'SVP_0',
    'DISPID_SpeechGrammarRuleState', 'SFTSREngine',
    'DISPID_SRCERecognition', 'SAFT16kHz16BitMono', 'SPVPRI_ALERT',
    'SP_VISEME_21', 'DISPID_SVPause', 'SPPHRASE',
    'SPDKL_CurrentConfig', 'SVSFParseSsml', '__MIDL_IWinTypes_0009',
    'SPSHORTCUTPAIR', 'DISPID_SPIStartTime', 'SRAInterpreter',
    'DISPID_SPEAudioStreamOffset', 'SpeechPartOfSpeech',
    'DISPID_SWFEChannels', 'DISPID_SRRSpeakAudio', 'ISpStream',
    'SAFTCCITT_ALaw_11kHzMono', 'SPRULESTATE', 'SPEI_SOUND_END',
    'eLEXTYPE_PRIVATE12', 'SPAUDIOSTATE', 'DISPID_SPRuleParent',
    'ISpeechMemoryStream', 'DISPID_SMSSetData', 'SVPOver',
    'DISPID_SPEsItem', 'SAFTADPCM_11kHzMono', 'SAFTDefault',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechLexicon', 'SSFMCreate',
    'SSTTDictation', 'SPPS_RESERVED1', 'SPPS_NotOverriden',
    'DISPID_SGRSTNextState', 'SP_VISEME_12', 'SPCATEGORYTYPE',
    'SVSFParseSapi', 'SPXRO_SML', 'DISPID_SPRsCount',
    'DISPID_SPCIdToPhone', 'DISPID_SASCurrentDevicePosition',
    'SpeechGrammarRuleStateTransitionType',
    'SAFTCCITT_uLaw_11kHzMono', 'SVPNormal', 'DISPID_SGRId',
    'SP_VISEME_0', 'SPEI_MAX_SR', 'ISpeechGrammarRule',
    'DISPID_SpeechLexiconWords', 'SAFT11kHz16BitStereo',
    'SP_VISEME_11', 'DISPID_SpeechPhraseElement', 'SpMMAudioOut',
    'DISPID_SOTMatchesAttributes', 'SPEI_RESERVED6',
    'SAFT24kHz8BitStereo', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRState', 'SPDKL_LocalMachine', 'DISPID_SASetState',
    'SAFT48kHz8BitStereo', 'SECLowConfidence',
    'DISPID_SLPPartOfSpeech', 'DISPID_SDKSetStringValue',
    'SECFIgnoreCase', 'ISpEventSource', 'SDTReplacement',
    'SpeechRecoProfileProperties', 'SVP_18', 'SGDSInactive',
    'ISpeechTextSelectionInformation', 'SAFT22kHz8BitMono',
    'SECFEmulateResult', 'SAFT12kHz8BitStereo', 'SPGRAMMARWORDTYPE',
    '_SPAUDIOSTATE', 'Speech_Default_Weight',
    'DISPID_SRRGetXMLResult', 'SPLO_DYNAMIC', 'SPPS_Modifier',
    'SGLexical', 'SpeechRegistryLocalMachineRoot', 'SPSMF_UPS',
    'SpeechAudioState', 'DISPID_SRGCmdLoadFromResource', 'SVP_14',
    'DISPID_SVSInputSentencePosition', 'SpeechGrammarWordType',
    'DISPID_SOTDataKey', 'DISPID_SRGetPropertyString',
    'SpeechDictationTopicSpelling', 'SDKLCurrentUser',
    'SRERecoOtherContext', 'DISPID_SRRecognizer',
    'ISpeechObjectTokens', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRGIsPronounceable', 'DISPID_SPRulesCount',
    'DISPID_SPAStartElementInResult', 'DISPID_SRIsShared',
    'DISPID_SVGetVoices', 'STCInprocServer',
    'DISPID_SpeechRecognizer', 'SRERecognition', 'ISpDataKey',
    'IEnumString', 'SPEI_PROPERTY_NUM_CHANGE', 'SAFT12kHz16BitMono',
    'SPBO_TIME_UNITS', 'DISPID_SpeechVoice', 'SRESoundStart',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFT32kHz8BitStereo',
    'SpeechAudioFormatGUIDWave', 'SpeechRegistryUserRoot',
    'Speech_Max_Word_Length', 'SAFT16kHz16BitStereo',
    'SAFT8kHz8BitMono', 'DISPID_SGRSTransitions', 'ISpeechPhraseRule',
    'DISPID_SREmulateRecognition', 'DISPID_SRCPause',
    'DISPID_SPPChildren', 'DISPID_SPAPhraseInfo',
    'SAFT22kHz16BitStereo', 'ISpRecoGrammar2', 'SpeechLoadOption',
    'DISPID_SpeechGrammarRules', 'DISPID_SPRsItem',
    'ISpeechPhraseReplacement', 'eLEXTYPE_USER',
    'DISPID_SpeechDataKey', 'ISpeechRecoResultDispatch',
    'SREBookmark', 'ISpNotifySink', 'DISPID_SGRSTPropertyId',
    'SDKLDefaultLocation', 'DISPID_SPEActualConfidence',
    'eLEXTYPE_PRIVATE4', 'eLEXTYPE_VENDORLEXICON',
    'SPSERIALIZEDPHRASE', 'DISPID_SpeechPhraseRule', 'SGRSTTEpsilon',
    'DISPID_SRCEHypothesis', 'DISPID_SRCCmdMaxAlternates',
    'SPFM_CREATE_ALWAYS', 'SPRST_INACTIVE_WITH_PURGE',
    'SPCT_SUB_DICTATION', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SOTCategory', 'SDA_One_Trailing_Space', 'DISPID_SGRsAdd',
    'DISPID_SRGDictationLoad', 'ISpeechGrammarRules',
    'DISPID_SPERetainedStreamOffset', 'SPGS_EXCLUSIVE', 'STCAll',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SLGenerationId',
    'SSSPTRelativeToStart', 'SpeechPropertyResponseSpeed',
    'SpShortcut', 'DISPID_SRGetFormat', 'SVP_1', 'SPWORDLIST',
    'SPEI_UNDEFINED', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVEStreamEnd',
    'SPEI_RECOGNITION', 'SPWF_SRENGINE', 'DISPID_SPPsItem',
    'eLEXTYPE_RESERVED10', 'SPEI_START_SR_STREAM',
    'SAFTADPCM_44kHzStereo', 'SPLO_STATIC',
    'DISPID_SpeechPhraseProperties', 'SP_VISEME_4', 'SRTAutopause',
    'DISPID_SOTGetStorageFileName', 'SVEPhoneme', 'SPPS_LMA',
    'SAFTGSM610_8kHzMono', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechLexiconWords', 'SRCS_Enabled', 'SPVPRI_OVER',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SWFEBlockAlign',
    'ISpeechVoice', 'DISPID_SRRTLength', 'SVP_16',
    'DISPID_SLPs_NewEnum', 'DISPID_SMSALineId', 'SPAUDIOBUFFERINFO',
    'SPEI_SOUND_START', 'IEnumSpObjectTokens', 'DISPID_SPRs_NewEnum',
    'SPSEMANTICERRORINFO', 'SpeechUserTraining',
    'SPEI_SR_AUDIO_LEVEL', 'SPEI_TTS_AUDIO_LEVEL', 'SRTSMLTimeout',
    'eLEXTYPE_PRIVATE17', 'SPPHRASEPROPERTY',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPEAudioSizeBytes', 'SPAO_NONE', 'DISPID_SPPs_NewEnum',
    'DISPID_SPPNumberOfElements', 'SpObjectToken', 'SVF_None',
    'SPSModifier', 'DISPID_SpeechRecoContext', 'DISPID_SDKEnumValues',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSUnknown',
    'SpeechTokenKeyFiles', 'SpInProcRecoContext', 'SRAExport',
    'SVF_Emphasis', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SGRAttributes', 'SAFTGSM610_22kHzMono',
    'DISPID_SRAudioInputStream', 'SPEI_END_INPUT_STREAM',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVEViseme', 'SVP_2',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPBO_PAUSE',
    'SPINTERFERENCE_TOOSLOW', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRRSaveToMemory', 'SRARoot',
    'DISPID_SpeechPhraseReplacements', 'ISpRecoCategory',
    'SPRST_NUM_STATES', 'DISPID_SPIAudioSizeBytes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPSNotOverriden',
    'SDTAlternates', 'ISpNotifySource', 'DISPID_SVEEnginePrivate',
    'ISpeechLexiconWord', 'DISPID_SpeechAudioStatus', 'SSTTWildcard',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPEDisplayAttributes',
    'SITooLoud', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SVAudioOutputStream', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechPhraseRules',
    'SITooQuiet', 'SpeechTokenContext', 'DISPID_SOTGetDescription',
    'SpeechCategoryRecognizers', 'SPAR_Low', 'SVSFPurgeBeforeSpeak',
    'DISPID_SVEPhoneme', 'SPBO_NONE', 'SINoise',
    'DISPID_SVSInputSentenceLength', 'ISpStreamFormatConverter',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPILanguageId',
    'DISPID_SGRsCommitAndSave', 'SPBO_AHEAD', 'SVP_15',
    'DISPID_SLPsCount', 'IStream', 'DISPID_SWFEExtraData',
    'DISPID_SLPPhoneIds', 'DISPID_SLRemovePronunciation',
    'SpeechVoiceCategoryTTSRate', 'SPPHRASERULE',
    'SAFT24kHz16BitStereo', 'DISPID_SPRules_NewEnum',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechAudio', 'SPLEXICONTYPE',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SFSClose', 'SRTEmulated',
    'DISPID_SMSAMMHandle', 'DISPID_SRRDiscardResultInfo',
    'SVEEndInputStream', 'SRTReSent', 'SVSFIsXML',
    'DISPID_SABufferNotifySize', 'SpStreamFormatConverter',
    'DISPID_SLPType', 'SpeechAudioVolume', 'SPVPRIORITY',
    'DISPID_SASState', 'DISPID_SRSAudioStatus', 'DISPID_SVResume',
    'SpObjectTokenCategory', 'DISPID_SVRate', 'SpeechMicTraining',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SBSSeek',
    'DISPID_SRAudioInput', 'DISPID_SRCEInterference',
    'SpeechRecognizerState', 'SBOPause', 'DISPID_SRRAudioFormat',
    'DISPID_SRRTOffsetFromStart', 'ISpRecognizer2',
    'DISPID_SVSRunningState', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVVolume', 'SPWORD', 'SPFILEMODE', 'SPCT_COMMAND',
    'SPWT_PRONUNCIATION', 'SPAR_Medium', 'DISPID_SWFEFormatTag',
    'SpeechCategoryAppLexicons', 'SpeechCategoryAudioIn', 'SLOStatic',
    ...
    'SSFMCreateForWrite', 'SVEAudioLevel', 'DISPID_SRGRecoContext',
    'ISpeechPhraseReplacements', 'SPCT_SLEEP',
    'SGDSActiveUserDelimited', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SAFGuid', 'DISPID_SpeechMMSysAudio',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SAEventHandle',
    'DISPID_SBSRead', 'SPINTERFERENCE_NOISE', 'eLEXTYPE_PRIVATE7',
    'DISPID_SOTCId', 'SPSMF_SAPI_PROPERTIES',
    'SpPhoneticAlphabetConverter', 'SAFT22kHz16BitMono',
    'DISPID_SRGDictationSetState', 'ISpeechPhraseElements',
    'SVSFIsNotXML', 'ISpResourceManager', 'SRTStandard', 'SVP_12',
    'SAFTADPCM_44kHzMono', 'SRSInactiveWithPurge', 'SGRSTTWildcard',
    'ISpeechRecoContext', 'ISpeechAudioStatus', 'SASPause',
    'SRSEDone', 'DISPIDSPTSI_ActiveLength', 'SDKLCurrentConfig',
    'SPEI_ADAPTATION', 'ISpeechObjectTokenCategory', 'SDTAudio',
    'SAFT44kHz8BitMono', 'DISPID_SRCState', 'DISPIDSPTSI',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SGRsCount', 'SP_VISEME_17',
    'SECHighConfidence', 'SPSHORTCUTTYPE', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SADefaultFormat', 'DISPID_SRSSupportedLanguages',
    'DISPID_SpeechLexiconWord', 'DISPID_SOTsItem',
    'SpNotifyTranslator', 'SGDisplay', 'SAFT32kHz16BitMono',
    'DISPID_SRGetPropertyNumber', 'SPRECORESULTTIMES',
    'DISPID_SOTCDefault', 'SPEI_FALSE_RECOGNITION', 'SPGS_ENABLED',
    'STSF_LocalAppData', 'DISPID_SVGetAudioInputs',
    'SPAO_RETAIN_AUDIO', 'SASRun',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRSetPropertyString',
    'SVSFVoiceMask', 'DISPID_SRStatus', 'SRADefaultToActive',
    'SPPS_Unknown', 'SPWAVEFORMATTYPE',
    'DISPID_SVSLastStreamNumberQueued', 'SRSActiveAlways',
    'DISPID_SVSVisemeId', 'SP_VISEME_19', 'SpeechVoiceEvents',
    'DISPID_SGRSTText', 'SSFMOpenReadWrite', 'SpeechAllElements',
    'eLEXTYPE_RESERVED6', 'DISPID_SPCPhoneToId', 'ISpeechRecognizer',
    'DISPID_SpeechObjectTokens', 'ISpeechLexiconPronunciations',
    'DISPID_SVSkip', 'SPPS_SuppressWord', 'DISPID_SPIGetText',
    'SP_VISEME_6', 'DISPID_SpeechObjectToken', 'eLEXTYPE_PRIVATE14',
    'SPAS_RUN', 'SPAS_CLOSED', 'SRSActive', 'SPRECOGNIZERSTATUS',
    'SLTUser', 'SPSNoun', 'DISPID_SABIMinNotification',
    'DISPID_SDKDeleteValue', 'DISPID_SRCAudioInInterferenceStatus',
    'eLEXTYPE_RESERVED8', 'SLTApp', '_ISpeechVoiceEvents',
    'SPINTERFERENCE_TOOLOUD', 'ISpStreamFormat', 'ISpGrammarBuilder',
    'DISPID_SPPName', 'DISPID_SpeechFileStream', 'STSF_CommonAppData',
    'ISpeechPhoneConverter', 'SP_VISEME_7', 'SP_VISEME_5',
    'SPPARTOFSPEECH', 'SP_VISEME_8', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRRRecoContext', 'DISPID_SpeechLexiconProns',
    'SpeechPropertyAdaptationOn', 'STSF_FlagCreate', 'ISpeechDataKey',
    'SAFT22kHz8BitStereo', 'SRCS_Disabled', 'SREStreamStart',
    'DISPID_SPRuleName', 'SPRST_ACTIVE', 'eLEXTYPE_RESERVED4',
    ...
    'SpeechGrammarTagDictation', 'DISPID_SGRSTType',
    'DISPID_SGRsCommit', 'tagSPTEXTSELECTIONINFO',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCEEndStream',
    'DISPID_SRCRecognizer', 'SAFT11kHz8BitStereo',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVAlertBoundary', 'SPRULE',
    'DISPID_SpeechBaseStream', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechAudioFormat',
    'DISPID_SDKDeleteKey', 'SPEI_RECO_STATE_CHANGE'
]

_check_version('1.1.14', 1615393829.610358)
